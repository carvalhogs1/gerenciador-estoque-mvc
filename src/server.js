...
app.post("/autenticar", estoqueController.renderizarPaginaEstoque)
...
app.get("/criar-produto", estoqueController.adicionarProduto)

app.post("/estoque", estoqueController.adicionarProduto)
